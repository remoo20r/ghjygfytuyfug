...
String? _rootRedirect(BuildContext context, GoRouterState state) {
  ...
  // The device type (phone / TV) is now chosen on the login screen itself
  // (see AddProfileScreen), so the standalone /device-mode picker is no longer
  // part of the first-run flow. When no playlist exists yet, go straight to
  // the login/add screen.
